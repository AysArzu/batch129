...
public class lambda3 {
    public static void main(String[] args) {
       ...
       boolean result1= coursesList.stream().allMatch(t->t.getAverageScore()>91);
        ...
        //Kurs isimlerinden en az birinin turkish kelimesini icerip icermdigini kontrol ediniz
        boolean result2= coursesList.stream().anyMatch(t->t.getCourseName().contains("Turkish"));
        System.out.println(result2);

        //3)Average scoru'u en yuksek olan kursun ismini console"a yazdiran kodu yaziniz
       String name1= coursesList.
        ...
        //5)Tum course object'lerini average score'a gore kucukten buyuge diziniz ve ilk ucunuliste halinde yaziniz
        ...
        //5)Tum course object'lerini average score'a gore kucukten buyuge diziniz ve ucuncuyu console'a yaziniz
